...
```bash
git remote add encore encore://pomodoro-timer-app-rcy2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/pomodoro-timer-app-rcy2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/pomodoro-timer-app-rcy2/settings/integrations/github)
