...
export namespace pomodoro {
    ...
    export class ServiceClient {
         ...
         */
        public async completeSession(params: RequestType<typeof api_pomodoro_complete_session_completeSession>): Promise<ResponseType<typeof api_pomodoro_complete_session_completeSession>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/sessions`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pomodoro_complete_session_completeSession>
        }
         ...
         */
        public async getSettings(): Promise<ResponseType<typeof api_pomodoro_get_settings_getSettings>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/settings`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pomodoro_get_settings_getSettings>
        }

        /**
         * Retrieves user statistics for completed sessions and tasks.
         */
        public async getStatistics(): Promise<ResponseType<typeof api_pomodoro_get_statistics_getStatistics>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/statistics`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pomodoro_get_statistics_getStatistics>
        }
         ...
         */
        public async updateSettings(params: RequestType<typeof api_pomodoro_update_settings_updateSettings>): Promise<ResponseType<typeof api_pomodoro_update_settings_updateSettings>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/settings`, {method: "PUT", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pomodoro_update_settings_updateSettings>
        }

        /**
         * Updates an existing task.
         */
        public async updateTask(params: RequestType<typeof api_pomodoro_update_task_updateTask>): Promise<ResponseType<typeof api_pomodoro_update_task_updateTask>> {
            // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
            const body: Record<string, any> = {
                description:        params.description,
                estimatedPomodoros: params.estimatedPomodoros,
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pomodoro_update_task_updateTask>
        }
    }
}
